    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-2xl bg-[#0A0A0A] border border-white/10 rounded-2xl overflow-hidden card-neural"
        >
          ...
          {/* Header */}
          <div className="px-6 md:px-8 pt-8 pb-4 border-b border-white/10 relative overflow-hidden">
            {/* Glow triádico sutil */}
          ...
          <div
            ...
            className="px-6 md:px-8 py-6 max-h-[40vh] overflow-y-auto text-white/60 text-xs leading-relaxed space-y-4 scrollbar-thin"
          >
            <p>
            ...
            <p className="gradient-text-triad text-xs font-medium">
              ← Desplázate hasta el final para aceptar
            </p>
          </div>

          {/* Footer */}
          <div className="px-6 md:px-8 py-6 border-t border-white/10 bg-black/40 space-y-4 relative overflow-hidden">
            {/* Glow inferior */}
                  ...
                  <div
                    className={`w-5 h-5 rounded border-2 flex items-center justify-center transition-all ${
                      accepted
                        ...
                        : hasScrolledToBottom
                        ? 'border-[#FF5A36]/40 group-hover:border-[#FF5A36]'
