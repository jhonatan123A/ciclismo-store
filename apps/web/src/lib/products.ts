...
export const products: Product[] = [
  {
    ...
    discount: 24,
    images: [
      '/images/products/running-main.jpg',
      '/images/products/running-detail1.jpg',
      '/images/products/running-detail2.jpg',
    ],
    sizes: ['XS', 'S', 'M', 'L'],
  ...
  },
  {
    ...
    discount: 24,
    images: [
      '/images/products/cycling-main.jpg',
      '/images/products/cycling-detail1.jpg',
      '/images/products/cycling-detail2.jpg',
    ],
    sizes: ['XS', 'S', 'M', 'L'],
    colors: ['Negro', 'Gris', 'Café'],
